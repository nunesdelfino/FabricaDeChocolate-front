...
import {RelatoriosClientService} from '../shared/relatorio-vendas-client/relatorios-client.service';
...
export class RelatoriosListComponent extends AbstractComponent implements OnInit {
  ...
  public displayedColumns = [ 'id', 'tipo', 'tamanho', 'sabores'];
  ...
  public sabores(element): string {
    let s = element.nomeSaborUm;
    if (element.nomeSaborDois != null) {
      s = s + ' -- ' +  element.nomeSaborDois;
    }
    if (element.nomeSaborTres != null) {
      s = s + ' -- ' +  element.nomeSaborTres;
    }
    if (element.nomeSaborQuatro != null) {
      s = s + ' -- ' +  element.nomeSaborQuatro;
    }
    if (element.nomeSaborCinco != null) {
      s = s + ' -- ' +  element.nomeSaborCinco;
    }
    return s;
  }
