...
export class AppMessage implements InternacionalizacaoResource {
  ...
  constructor() {
    this.resource = {
      ...
      LABEL_VOLTAR: 'Voltar',
      LABEL_LOGIN: 'Login',
      LABEL_INFORME_LOGIN: 'Digite seu Funcionário',
      LABEL_INFORME_SENHA: 'Digite sua senha',
      LABEL_ENTRAR: 'Entrar',
      LABEL_USUARIO: 'Funcionário',
      ...
      LABEL_SABOR: 'Sabor',
      LABEL_STATUS_SABOR: 'Status do Sabor',
      ...
      LABEL_PESQUISAR_USUARIO: 'Pesquisar Funcionário',
      LABEL_ALTERAR_USUARIO: 'Alterar Funcionário',
      LABEL_INCLUIR_USUARIO: 'Incluir Funcionário',
      LABEL_VISUALIZAR_USUARIO: 'Visualizar Funcionário',
      LABEL_USUARIO_HINT: 'Digite o nome do Funcionário',
      LABEL_LOGIN_HINT: 'Digite o login do Funcionário',
      LABEL_TIPO_CADASTRO: 'Tipo de Cadastro',
      LABEL_STATUS_PORTAL: 'Status do Funcionário',
      ...
      LABEL_SELECIONAR_USUARIO_AD: 'Selecionar Funcionário do AD',
      ...
      LABEL_TIPO_USUARIO: 'Tipo de Funcionários',
      ...
      LABEL_DADOS_USUARIO: 'Dados do Funcionário',
      LABEL_IP_USUARIO: 'IP do Funcionário',
      ...
      MSG003: 'Funcion\u00E1rio n\u00E3o cadastrado.',
      MSG004: 'Funcion\u00E1rio e senha n\u00E3o conferem.',
      MSG005: 'Funcion\u00E1rio est\u00E1 inativo no sistema AD.',
      MSG006: 'Deseja remover este item?',
      MSG007: 'Opera\u00E7\u00E3o realizada com sucesso.',
      MSG008: 'Funcion\u00E1rio est\u00E1 inativo no portal.',
      MSG009: 'Funcion\u00E1rio n\u00E3o tem permiss\u00E3o de acesso ao sistema desejado.',
      MSG010: 'Confirmar operação?',
      MSG011: 'O Grupo informado já foi adicionado ao Funcionário.',
      MSG012: 'Nenhum Funcionário foi selecionado.',
      MSG013: 'O CPF informado já está em uso.',
      MSG014: 'O Telefone informado já foi adicionado ao Funcionário.',
      ...
      MSG036: 'Nenhum Funcion\u00E1rio foi selecionado.',
      ...
      MSG042: 'Funcion\u00E1rio Bloqueado',
      MSG044: 'Funcion\u00E1rio n\u00E3o tem permiss\u00E3o de acesso a funcionalidade acessada.',
